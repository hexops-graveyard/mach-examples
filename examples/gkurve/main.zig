...
pub fn init(app: *App) !void {
    ...
    switch (demo_mode) {
        ...
        .bitmap_text => {
            ...
            var label = try Label.init(lib, assets.fonts.roboto_medium.path, 0, 110 * size_multiplier, core.allocator);
            defer label.deinit();
        ...
        .text => {
            ...
            try resizable_label.init(lib, assets.fonts.roboto_medium.path, 0, core.allocator, white_texture_uv_data);
